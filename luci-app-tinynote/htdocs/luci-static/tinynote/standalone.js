    ...
    var Ue = (t, e) => () => (e || t((e = {
        ...
        rr = (t, e, r, n) => {
            if (e && typeof e == "object" || typeof e == "function")
                for (let o of cu(e)) !fu.call(t, o) && o !== r && $e(t, o, {
                    get: () => e[o],
    ...
    var hn = Ue(pt => {
        ...
        function En(t, e, r = {}) {
            let n = (r.highlightCode || r.forceColor) && (0, pn.shouldHighlight)(r),
                ...
                f = String(D).length,
                l = (n ? (0, pn.default)(t, r) : t).split(mn, D).slice(a, D).map((p, m) => {
                    let E = a + 1 + m,
                        g = ` ${` ${E}`.slice(-f)} |`,
                        C = c[E],
                        _ = !c[E + 1];
...
`)
    ...
    function Ar(t) {
        for (t = [...t]; t.length >= 2 && y(!1, t, -2).type === x && y(!1, t, -1).type === b;) t.length -= 2;
        if (t.length > 0) {
            let e = Oe(y(!1, t, -1));
            t[t.length - 1] = e
        }
    ...
    function Oe(t) {
        switch (W(t)) {
            ...
            case B:
                return {
                    ...t, breakContents: Oe(t.breakContents), flatContents: Oe(t.flatContents)
                };
            case k:
                return {
                    ...t, parts: Ar(t.parts)
...
`)) : r)
    ...
    function kt(t) {
        ...
        if (e > 0 || r > 0)
            for (t.length = n + 1; r-- > 0;) t.push(Te);
        return e
    }
        ...
        for (; r >= 0;) {
            ...
            switch (W(c)) {
                ...
                case A: {
                    ...
                    let F = c.break ? R : D,
                        f = c.expandedStates && F === R ? y(!1, c.expandedStates, -1) : c.contents;
                    s.push({
                        mode: F,
                        doc: f
                    });
...
in order for it to be formatted.`,
    ...
    function et({
        ...
        let r = t.flatMap(o => o.languages ?? []),
            n = [];
        for (let o of Ru(Object.assign({}, ...t.map(({
            options: u
        }) => u), vr))) !e && o.deprecated || (Array.isArray(o.choices) && (e || (o.choices = o.choices.filter(u => !u.deprecated)), o.name === "parser" && (o.choices = [...o.choices, ...Iu(o.choices, r, t)])), o.pluginDefaults = Object.fromEntries(t.filter(u => {
            var i;
    ...
    function Vu(t, e) {
        let r = t.plugins.flatMap(o => o.languages ?? []),
            n = ju(r, e.language) ?? Pr(r, e.physicalFile) ?? Pr(r, e.file) ?? (e.physicalFile, void 0);
    ...
    var jr = " ".repeat(2),
        $r = (t, e, r) => {
            let {
                text: n,
                list: o
            } = r.normalizeExpectedResult(r.schemas[t].expected(r)), u = [];
...
`, 1)[0].length);
    ...
    function Ot(t, e) {
        ...
        for (; F < o;)
            for (i = e.charCodeAt(u + F), a = F++, s = F, c = 0; c < n; c++) D = i === Wr[c] ? a : a + 1, a = wt[c], s = wt[c] = a > s ? D > s ? s + 1 : D : D > a ? a + 1 : D;
        return s
    }
    var rt = (t, e, {
        descriptor: r,
        ...
        let u = [`Ignored unknown option ${Nt.default.yellow(r.pair({ key: t, value: e }))}.`],
    ...
    var at = class extends w {
        ...
        expected({
            ...
            let r = Array.from(this._choices.keys()).map(i => this._choices.get(i)).filter(({
                hidden: i
            }) => !i).map(i => i.value).sort(Zr).map(e.value),
                n = r.slice(0, -2),
                o = r.slice(-2);
            return {
    ...
    var lt = class {
        ...
        _applyRequiredCheck(e) {
            for (let r of Object.keys(this._utils.schemas))
                if (this._identifyMissing(r, e) && this._identifyRequired(r)) throw this._invalidHandler(r, tt, this._utils)
        }
        ...
        _applyPostprocess(e) {
            ...
            if (r !== de) {
                if (r.delete)
                    for (let n of r.delete) delete e[n];
                if (r.override) {
                    let {
                        knownKeys: n,
                        unknownKeys: o
    ...
    async function qu(t, e = {}) {
        ...
        let s = (F = u.printers) != null && F[i.astFormat] ? u : on(r.plugins, i.astFormat),
...
` || o === "\r" || o === "\u2028" || o === "\u2029") return e + 1
    ...
    function fo(t) {
        let e = t.type || t.kind || "(unknown type)",
            r = String(t.name || t.id && (typeof t.id == "object" ? t.id.name : t.id) || t.key && (typeof t.key == "object" ? t.key.name : t.key) || t.value && (typeof t.value == "object" ? "" : String(t.value)) || t.operator || "");
    ...
    function Et(t, e) {
        ...
        if (!n) return [];
        let s = ((r == null ? void 0 : r(t, e)) ?? [...Mt(t, {
            getVisitorKeys: H(o)
    ...
    function kn(t, e, r, n) {
        let {
            locStart: o,
            locEnd: u
        } = r, i = o(e), s = u(e), a = Et(t, r), D, c, F = 0, f = a.length;
        for (; F < f;) {
            let d = F + f >> 1,
                l = a[d],
                p = o(l),
    ...
    function bn(t, e) {
        ...
        for (let [d, l] of f.entries()) {
            ...
            let $;
            if (i ? $ = [l] : (p.enclosingNode = E, p.precedingNode = m, p.followingNode = h, $ = [p, g, C, _, Z]), po(g, C, f, d)) p.placement = "ownLine", D(...$) || (h ? ne(h, p) : m ? ue(m, p) : E ? X(E, p) : X(_, p));
    ...
    function Bn(t, e) {
        ...
        for (let [D, {
            comment: c
        }] of t.entries()) D < i ? ue(n, c) : ne(o, c);
        for (let D of [n, o]) D.comments && D.comments.length > 1 && D.comments.sort((c, F) => e.locStart(c) - e.locStart(F));
        t.length = 0
    }
    ...
    function Kt(t, e, r) {
        ...
        for (let o = 1; o < t.length; ++o)
            if (n < r.locStart(t[o])) return o - 1;
        return 0
    }
    ...
    function Tn(t) {
        let {
            [Symbol.for("comments")]: e, [Symbol.for("printedComments")]: r
        } = t;
        for (let n of e) {
    ...
    var Yn = new Set(["JsonRoot", "ObjectExpression", "ArrayExpression", "StringLiteral", "NumericLiteral", "BooleanLiteral", "NullLiteral", "UnaryExpression", "TemplateLiteral"]),
        bo = new Set(["OperationDefinition", "FragmentDefinition", "VariableDefinition", "TypeExtensionDefinition", "ObjectTypeDefinition", "FieldDefinition", "DirectiveDefinition", "EnumTypeDefinition", "EnumValueDefinition", "InputValueDefinition", "InputObjectTypeDefinition", "SchemaDefinition", "OperationTypeDefinition", "InterfaceTypeDefinition", "UnionTypeDefinition", "ScalarTypeDefinition"]);
    ...
    function wo(t, e) {
        let {
            ...
            locStart: n,
            locEnd: o
        } = e, u = H(e.printer.getVisitorKeys), i = a => n(a) <= r && o(a) >= r, s = t;
        for (let a of An(t, {
            getVisitorKeys: u,
            filter: i
        })) s = a;
    ...
    async function Oo(t, e) {
        let {
            ...
            rangeStart: o,
            rangeEnd: u
        } = jn(n, e, r), i = n.slice(o, u), s = Math.min(o, n.lastIndexOf(`
...
`);
    ...
    async function Hn(t, e, r) {
        let {
            text: n,
            options: o
        } = Kn(t, await re(e)), u = await ae(n, o);
...
`) return !0;
    ...
    function Vo(t, e, r) {
        let n = e === '"' ? "'" : '"',
            u = ee(!1, t, /\\(.)|(["'])/gs, (i, s, a) => s === n ? s : a === e ? "\\" + a : a || (r && /^[^\n\r"'0-7\\bfnrt-vx\u2028\u2029]$/.test(s) ? s : "\\" + s));
        return e + u + e
    }
    var uu = Vo;
