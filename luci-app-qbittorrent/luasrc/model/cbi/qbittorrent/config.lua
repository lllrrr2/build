local a, t, e
local s = luci.util.trim(luci.sys.exec("qbittorrent-nox -v 2>/dev/null | awk '{print $2}'"))
...
a = Map("qbittorrent", translate("qBittorrent 下载器"), translate("一个基于QT的跨平台的开源BitTorrent客户端<br>Web默认用户名：admin 密码：adminadmin"))
...
e.description = e.description .. translatef("Current version of qBitTorrent: <b style=\"color:green\"> %s", s) .. "</b>"
e.default = "1"
