...
local v = sys.exec("qbittorrent-nox -v 2>/dev/null | awk '{print $2}'")

function titlesplit(e)
	return "<p style = \"font-size:15px;font-weight:bold;color: DodgerBlue\">" .. translate(e) .. "</p>"
end

a = Map("qbittorrent", translate("qBittorrent 下载器"),
translate("一个基于QT的跨平台的开源BitTorrent客户端<br>Web默认用户名：admin 密码：adminadmin"))
...
translatef("Current version of qBitTorrent: <b style=\"color:green\"> %s", v) .. "</b>")
e.default = "1"
...
e = t:taboption("basic", Value, "profile", translate("Parent Path for Profile Folder"),
translate("The path for storing profile folder using by command: <b>--profile [PATH]</b>."))
e.default = '/tmp'

e = t:taboption("basic", Value, "SavePath", translate("Save Path"),
translate("The path to save the download file. For example:<code>/mnt/sda1/download</code>"))
...
e = t:taboption("basic", Value, "Port", translate("Listen Port"),
...
translate("Use UPnP/ NAT-PMP port forwarding from my router."))
e.enabled = "true"
e.disabled = "false"
e.default = e.enabled

e = t:taboption("connection", Flag, "UseRandomPort", translate("Use Random Port"),
translate("Use different port on each startup voids the first"))
e.enabled = "true"
e.disabled = "false"
e.default = e.disabled

e = t:taboption("connection", Value, "PortRangeMin", translate("Connection Port"),
translate("Generate Randomly"))
...
translate("Global Download Speed Limit(KiB/s)."))
e.datatype = "float"
e.placeholder = "0"
...
e = t:taboption("connection", ListValue, "BTProtocol", translate("Enabled protocol"),
translate("The protocol that was enabled."))
...
e = t:taboption("downloads", Flag, "AutoDeleteAddedTorrentFile",
translate("Auto Delete Torrent File"),
...
translate("The incomplete task will be added the extension of !qB."))
e.enabled = "true"
e.disabled = "false"
e.default = e.enabled
...
e = t:taboption("downloads", Value, "DiskWriteCacheSize",
translate("Disk Cache Size (MiB)"),
translate("The value -1  is auto and 0 is disable. In default,  it is set to 64MiB."))
e.datatype = "integer"
e.placeholder = "64"

e = t:taboption("downloads", Value, "DiskWriteCacheTTL",
translate("Disk Cache TTL (s)"),
translate("In default,  it is set to 60s."))
e.datatype = "integer"
e.placeholder = "60"
...
e = t:taboption("bittorrent", Flag, "uTP_rate_limited", translate("uTP Rate Limit"),
translate("Apply rate limit to µTP protocol."))
e.enabled = "true"
e.disabled = "false"
e.default = e.enabled
...
translate("The max number of connections."))
e.datatype = "integer"
e.placeholder = "500"

e = t:taboption("bittorrent", Value, "MaxConnecsPerTorrent", translate("Max Connections Per Torrent"),
translate("The max number of connections per torrent."))
e.datatype = "integer"
e.placeholder = "100"
...
e = t:taboption("bittorrent", Value, "MaxRatio", translate("Max Ratio"),
translate("The max ratio for seeding. -1 is to disable the seeding."))
e.datatype = "float"
e.placeholder = "-1"
...
e = t:taboption("bittorrent", Value, "GlobalMaxSeedingMinutes", translate("Max Seeding Minutes"),
...
e = t:taboption("bittorrent", Flag, "IgnoreSlowTorrents", translate("Ignore Slow Torrents"),
translate("Do not count slow torrents in these limits."))
e.enabled = "true"
e.disabled = "false"
e.default = e.disabled

e = t:taboption("bittorrent", Value, "SlowTorrentsDownloadRate", translate("Download rate threshold"),
translate("Units: KiB/s"))
e.datatype = "integer"
e.placeholder = "2"

e = t:taboption("bittorrent", Value, "SlowTorrentsUploadRate", translate("Upload rate threshold"),
translate("Units: KiB/s"))
e.datatype = "integer"
e.placeholder = "2"

e = t:taboption("bittorrent", Value, "SlowTorrentsInactivityTimer", translate("Torrent inactivity timer"),
...
e = t:taboption("webgui", Flag, "LocalHostAuth", translate("Local Host Authentication"),
translate("Force authentication for clients on localhost."))
e.enabled = "true"
e.disabled = "false"
e.default = e.disabled
...
translate("When enabled,  qBittorrent will take certain measures to try"))
e.enabled = "true"
e.disabled = "false"
e.default = e.enabled
...
e = t:taboption("advanced", Value, "OutgoingPortsMax", translate("Max Outgoing Port"),
translate("The max outgoing port."))
e.datatype = "port"

e = t:taboption("advanced", Value, "OutgoingPortsMin", translate("Min Outgoing Port"),
translate("The min outgoing port."))
e.datatype = "port"

e = t:taboption("advanced", ListValue, "SeedChokingAlgorithm", translate("Choking Algorithm"),
translate("The strategy of choking algorithm."))
...
e = t:taboption("advanced", Flag, "Backup", translate("Enable Backup"),
...
e = t:taboption("advanced", Flag, "DeleteOld", translate("Delete Old Backup"),
translate("Delete the old log file."))
e:depends("Enabled", "true")
e.enabled = "true"
e.disabled = "false"
e.default = e.enabled

e = t:taboption("advanced", Value, "MaxSizeBytes", translate("Log Max Size"),
translate("The max size for qbittorrent log (Unit: Bytes)."))
e:depends("Enabled", "true")
e.placeholder = "66560"

e = t:taboption("advanced", Value, "SaveTime", translate("Log Saving Period"),
translate("The log file will be deteted after given time. 1d -- 1 day,  1m -- 1 month,  1y -- 1 year"))
e:depends("Enabled", "true")
e.datatype = "string"
