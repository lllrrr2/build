...
local RootProfilePath = t:taboption("basic", Value, "RootProfilePath", translate("Root Path of the Profile"),
...
e = t:taboption("bittorrent", Flag, "QueueingSystemEnabled", translate("Enable Torrent Queueing"))
e.enabled = "true"
e.disabled = "false"
e.default = e.disabled
